...
PASO_R="R"+str(PASO)
PASO_L="L"+str(PASO)
PASO_180_R="R"+str(NUM_TOTALES/2)
PASO_180_L="L"+str(NUM_TOTALES/2)
PASO_360_R="R"+str(NUM_TOTALES)
PASO_360_L="L"+str(NUM_TOTALES)
...
def medicion(i):
    ...
    num=str(i)
    num=num+".npy"
    print("\nSaving [db] data to ../medidas/testing\n"+num)
    outfile = TemporaryFile()
    np.save("../medidas/testing"+num,db)
    _ = outfile.seek(0)
    print("Saved file:",np.load("../medidas/testing"+num))
